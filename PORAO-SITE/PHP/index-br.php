<html>
   ...
   <body>
               ...
               <div class="d-flex w-100" style="display: ruby;">
                  ...
                  <div class="d-flex align-items-center" id="navbarNav">
                     <ul class="nav justify-content-center"> 
                        <li class="nav-item">
                           <a class="nav-link text-nav" href="#" data-page="home-br">Home</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link text-nav" href="#" data-page="sobre">Sobre</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link text-nav" href="#" data-page="contacts">Contatos</a>
                        </li>  
                     </ul>
                  </div>
                  <a class="navbar-brand ml-auto d-flex align-items-center" href="http://localhost/PORAO-SITE/PORAO-SITE/PHP/index.php" style="margin: 0px; ">
                     <img src="../IMG/us.svg" width="30" height="30" style="border: 0px; margin-right: 10px;" class="d-inline-block" alt="">
                  </a>
               </div>
            </nav>
      ...
      <div class="footer">
         <a>Copyright © 2024 Porão Security®. Todos os direitos reservados.</a>
      </div>
